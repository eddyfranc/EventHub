    ...
    if (file) {
      ...
      reader.onloadend = () => {
        setEventData((prev) => ({
          ...prev,
          eventImage: file,
          eventImagePreview: reader.result, // ✅ Base64
        }));
      };
      ...
      <div className="flex-grow flex justify-center items-start py-8 px-4">
        <div className="w-full max-w-4xl">
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-8 rounded shadow">
            ...
            <div><label className="block font-semibold mb-1">Event type</label>
            ...
            <div><label className="block font-semibold mb-1">Organizer</label>
