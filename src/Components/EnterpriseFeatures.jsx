...
// const stats = [
//   { label: "EventHub Organisers", value: "2K+" },
//   { label: "Total Ticket Sales", value: "20M+" },
//   { label: "Requests per Minute", value: "10K+" },
// ];
...
//         </p>
//         <button className="bg-orange-500 hover:bg-green-600 text-white px-6 py-2 rounded-lg font-semibold mb-12 transition duration-300 ease-in-out transform hover:-translate-y-1">
//           Request A Demo
//         </button>
